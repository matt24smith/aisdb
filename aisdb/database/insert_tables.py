...
def insert_msg5(cur, mstr, rows):
    ...
    tup5 = ((r['type'], r['repeat'], int(r['mmsi']), r['ais_version'],
             r['imo'], r['callsign'], r['shipname'].rstrip(), r['shiptype'],
             r['to_bow'], r['to_stern'], r['to_port'], r['to_starboard'],
             r['epfd'], r['month'], r['day'], r['hour'], r['minute'],
             r['draught'], r['destination'], r['dte'], r['epoch'])
            for r in rows)
    cur.executemany(
        f'INSERT INTO ais_{mstr}_msg_5 '
...
def insert_msg24(cur, mstr, rows):
    ...
    cur.executemany(
        f'INSERT INTO ais_{mstr}_msg_24 '
